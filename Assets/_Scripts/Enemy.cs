...
public class Enemy : Entity, IDamageable, IDamageDealer {
    ...
    public override bool CheckLedgeFoot() {
        return Physics2D.Raycast(GroundPoint.position.ToVector2(), Vector2.right * FacingDirection * enemyData.ledgeFootCheckOffset.x, enemyData.ledgeCheckDistance, enemyData.wallLayer);
    }
